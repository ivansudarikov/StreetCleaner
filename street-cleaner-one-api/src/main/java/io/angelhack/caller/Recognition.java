...
public class Recognition {
    public static String recognize() {
        ...
        if (new File("test2.jpg").exists()) {
            String s = ocr.recognize(new File[]{new File("test2.jpg")},
    ...
    public static String recognize(File file) {
        ...
        number = new StringBuilder(number.toString().replaceAll(" ", ""));
        number.append(s.substring(index, index+11));
